  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text("Ulivery"),
      ),
      body: const ServicePageBody(),
    );
  }
}
    ...
    return SizedBox(
      ...
      child: Padding(
        ...
        child: ElevatedButton(
          style:
              ButtonStyle(backgroundColor: MaterialStateProperty.all<Color>(Theme.of(context).colorScheme.secondary)),
          onPressed: pressed,
          child: Row(
            children: <Widget>[
              Expanded(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                        text,
                        style: TextStyle(fontSize: 33, color: Theme.of(context).colorScheme.primary),
              ...
              Expanded(
                  ...
                  child: Align(
                    ...
                    child: Padding(padding: const EdgeInsets.symmetric(vertical: 3.0), child: Image.asset(image)),
                  ))
            ],
          ),
        ),
