        ...
        children: <Widget>[
          Container(
              child: Padding(
                  ...
                  child: Text("Bestelling", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),)),
          ),
          Container(
            child: ListView(
              ...
              children: <Widget>[
                ...
                ProductCard(screenWidth: screenWidth,
                    image: 'assets/img/pumpkin.png',
                    producttitle: 'Pompoen',
                    subtitle: '€5,10\nGegrilde aubergine en chimichurri',
                    productcount: '1'
                ...
                Padding(
                      ...
                      child: Row(
                        ...
                        children: <Widget>[
                          Text("Totaal: ", style: TextStyle(fontSize: 20),),
                          Text("€12,34", style: TextStyle(fontSize: 20),)
          ...
          Container(
            child: Text("Klantgegevens", style: TextStyle(fontSize: 30, fontWeight: FontWeight.bold),),
          ),
          Container(
              child: Column(
                children: <Widget>[
                  DeliveryInfoField(screenWidth: screenWidth, label: 'Locatie', text: 'Heerlen - Nieuw Eyckholt',),
          ...
          Container(
              child: Center(
                  child: RoundedButton(text: 'Accepteren', press: () {}, color: Theme.of(context).colorScheme.secondary, textColor: Theme.of(context).colorScheme.primary,)))
...
class DeliveryInfoField extends StatelessWidget {
  ...
  const DeliveryInfoField({
    ...
    Key? key,
    required this.screenWidth, required this.label, required this.text,
  }) : super(key: key);
...
class ProductCard extends StatelessWidget {
  ...
  const ProductCard({
    Key? key,
    required this.screenWidth, required this.image, required this.producttitle, required this.subtitle, required this.productcount,
  }) : super(key: key);
